      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mb-10">
          ...
          <p className="mt-4 text-lg text-on-brand/70">
            Оставьте заявку — свяжемся с вами, рассчитаем цену под ваш
            объём и предложим удобный способ попробовать продукт. Без обязательств.
          </p>
        </div>
            ...
            {submitted && (
              <div className="text-center py-12 animate-in fade-in duration-500">
                ...
                <p className="text-on-brand/70">
                   Свяжемся с вами в ближайшее время. Спасибо за доверие!
                </p>
              </div>
            )}
          </div>
