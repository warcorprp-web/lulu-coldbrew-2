    ...
    <section id="partnership" className="py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step) => (
            <div key={step.number} className="relative bg-white rounded-2xl p-6 before:absolute before:inset-0 before:rounded-2xl before:bg-[#f07d47]/5 before:pointer-events-none overflow-hidden">
              <div className="relative text-3xl font-black text-[#f07d47] leading-none mb-4">
                {step.number}
              </div>
              <h3 className="relative text-lg font-bold text-[#1a1a1a]">{step.title}</h3>
