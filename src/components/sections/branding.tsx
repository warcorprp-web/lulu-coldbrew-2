      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-on-brand">
              Бутылка с вашим именем
            </h2>
            <p className="mt-4 text-lg text-on-brand/70 leading-relaxed">
            ...
            <ul className="mt-8 space-y-3">
              {[
                ...
                <li key={item} className="flex items-center gap-3 text-on-brand/70">
                  <span className="w-5 h-5 rounded-full bg-[#f07d47] flex items-center justify-center text-on-brand text-xs font-bold shrink-0">✓</span>
                  {item}
                </li>
              ))}
            </ul>
            <a
              href="#contact"
              className="mt-8 inline-flex shrink-0 items-center justify-center rounded-full bg-[#f07d47] text-on-brand text-sm font-medium whitespace-nowrap transition-all select-none h-11 px-7 hover:bg-[#d86a39]"
            >
              Узнать условия
            </a>
          </div>
