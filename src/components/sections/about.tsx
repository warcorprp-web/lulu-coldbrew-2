      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
          <div>
            ...
            <p className="mt-6 text-on-brand/70 leading-relaxed text-lg">
        ...
        <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {items.map((item, i) => {
            ...
            return (
              <div key={i} className="relative flex items-start gap-3 rounded-xl bg-surface p-5 before:absolute before:inset-0 before:rounded-xl before:bg-[#f07d47]/5 before:pointer-events-none overflow-hidden">
                <div className="relative shrink-0 mt-1 [&_svg]:stroke-[#f07d47]">
                  <Icon />
                </div>
                <div className="relative">
                  <div className="text-xs font-semibold text-brand tracking-wider uppercase mb-1">
                    {item.label}
                  </div>
                  <div className="text-lg font-bold text-on-surface">{item.value}</div>
        ...
        <div className="mt-12 max-w-2xl mx-auto">
          <div className="pt-6 border-t border-on-brand/20">
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div>
                <span className="block font-semibold text-on-brand">Объём</span>
                <span className="text-on-brand/60">280 мл</span>
              </div>
              <div>
                <span className="block font-semibold text-on-brand">Срок хранения</span>
                <span className="text-on-brand/60">газированный 60 дней, не газированный 90 дней</span>
              </div>
              <div>
                <span className="block font-semibold text-on-brand">Кофеин</span>
                <span className="text-on-brand/60">как в обычной чашке кофе</span>
              </div>
            </div>
          </div>
        </div>
